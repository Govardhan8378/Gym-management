...
def admin_panel():
    ...
    if menu == "Dashboard":
        ...
        st.image(r"D:\ssproject\project\assets\gym_banner.jpg", 
        ...
        st.image(r"D:\ssproject\project\assets\members.png",
             use_container_width=20)
        
        tab1, tab2, tab3 = st.tabs(["View Members", "Add Member", "Update Member"])
        ...
        with tab3:
            ...
            if not members_df.empty:
                ...
                with st.form("update_member_form"):
                    ...
                    col1, col2 = st.columns(2)
                    update_btn = col1.form_submit_button("✏️ Update Member", type="primary")
                ...
                if st.button("🗑️ Delete Member", type="secondary"):
                    if st.checkbox(f"Confirm deletion of {member['name']}"):
        ...
        tab1, tab2 = st.tabs(["View Plans", "Add Plan"])
        ...
        tab1, tab2 = st.tabs(["View Subscriptions", "New Subscription"])
        ...
        with tab1:
            ...
            if not subs_df.empty:
                # Filter options
                col1, col2 = st.columns(2)
                status_filter = col1.selectbox("Filter by Status", ["All", "Active", "Inactive"])
        ...
        tab1, tab2 = st.tabs(["Today's Attendance", "Mark Attendance"])
